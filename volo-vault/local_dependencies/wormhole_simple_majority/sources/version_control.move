...
///
/// See `wormhole_simple_majority::state` and `wormhole_simple_majority::package_utils` for more info.
module wormhole_simple_majority::version_control {
    ////////////////////////////////////////////////////////////////////////////
    //
    ...
    friend wormhole_simple_majority::state;
