...
module wormhole_simple_majority::state {
    use std::vector::{Self};
    ...
    use wormhole_simple_majority::fee_collector::{Self, FeeCollector};
    use wormhole_simple_majority::guardian::{Guardian};
    use wormhole_simple_majority::guardian_set::{Self, GuardianSet};
    use wormhole_simple_majority::package_utils::{Self};
    use wormhole_simple_majority::version_control::{Self};

    friend wormhole_simple_majority::emitter;
    friend wormhole_simple_majority::governance_message;
    friend wormhole_simple_majority::migrate;
    friend wormhole_simple_majority::publish_message;
    friend wormhole_simple_majority::set_fee;
    friend wormhole_simple_majority::setup;
    friend wormhole_simple_majority::transfer_fee;
    friend wormhole_simple_majority::update_guardian_set;
    friend wormhole_simple_majority::upgrade_contract;
    friend wormhole_simple_majority::vaa;
    ...
    ///
    /// See `wormhole_simple_majority::vaa` for more info.
    ...
    /// necessarily have to be a `friend` to `wormhole_simple_majority::publish_message`. But
    /// we also do not want an integrator to mistakenly deposit fees outside
    /// of calling `publish_message`.
    ///
    /// See `wormhole_simple_majority::publish_message` for more info.
    ...
    ///
    /// See `wormhole_simple_majority::transfer_fee` for more info.
    ...
    ///
    /// See `wormhole_simple_majority::update_guardian_set` for more info.
    ...
    ///
    /// See `wormhole_simple_majority::set_fee` for more info.
