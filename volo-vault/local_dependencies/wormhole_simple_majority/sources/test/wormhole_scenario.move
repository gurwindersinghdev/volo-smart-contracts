...
module wormhole_simple_majority::wormhole_scenario {
    use std::vector::{Self};
    use sui::clock::{Self, Clock};
    use sui::package::{UpgradeCap};
    use sui::test_scenario::{Self, Scenario};

    use wormhole_simple_majority::emitter::{EmitterCap};
    use wormhole_simple_majority::governance_message::{Self, DecreeTicket, DecreeReceipt};
    use wormhole_simple_majority::setup::{Self, DeployerCap};
    ...
    public fun set_up_wormhole_with_guardians(
        ...
        wormhole_simple_majority::setup::init_test_only(test_scenario::ctx(scenario));
    ...
    public fun new_emitter(
        ...
        let emitter =
            wormhole_simple_majority::emitter::new(&worm_state, test_scenario::ctx(scenario));
