module pyth_pro_compatible::state {
    use std::vector;
    ...
    use pyth_pro_compatible::price_info::{Self};
    use pyth_pro_compatible::price_identifier::{Self, PriceIdentifier};
    use pyth_pro_compatible::version_control::{Self};
    ...
    friend pyth_pro_compatible::governance_action;
    friend pyth_pro_compatible::set_update_fee;
    friend pyth_pro_compatible::set_stale_price_threshold;
    friend pyth_pro_compatible::set_data_sources;
    friend pyth_pro_compatible::governance;
    friend pyth_pro_compatible::set_governance_data_source;
    friend pyth_pro_compatible::migrate;
    friend pyth_pro_compatible::contract_upgrade;
    friend pyth_pro_compatible::set_fee_recipient;
    friend pyth_pro_compatible::setup;
