...
module pyth_pro_compatible::merkle_tree {
    use std::vector::{Self};
    use sui::hash::{keccak256};
    use wormhole_simple_majority::bytes20::{Self, Bytes20, data};
    ...
    #[test]
    #[expected_failure(abort_code = pyth_pro_compatible::merkle_tree::E_DEPTH_NOT_LARGE_ENOUGH_FOR_MESSAGES)]
