...
/// 3.  Upgrade.
/// 4.  Commit upgrade.
module pyth_pro_compatible::contract_upgrade {
    use sui::event::{Self};
    use sui::object::{ID};
    ...
    use pyth_pro_compatible::governance_instruction::{Self};
    use pyth_pro_compatible::governance_action::{Self};
    use pyth_pro_compatible::governance::{Self, WormholeVAAVerificationReceipt};
