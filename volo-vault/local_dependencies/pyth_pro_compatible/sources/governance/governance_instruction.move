module pyth_pro_compatible::governance_instruction {
    use wormhole_simple_majority::cursor;
    use pyth_pro_compatible::deserialize;
    use pyth_pro_compatible::governance_action::{Self, GovernanceAction};
    ...
    fun validate(instruction: &GovernanceInstruction) {
        ...
        assert!(target_chain_id == (wormhole_simple_majority::state::chain_id() as u64) || target_chain_id == 0, E_TARGET_CHAIN_MISMATCH);
    }
