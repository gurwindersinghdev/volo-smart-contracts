module pyth_pro_compatible::pyth {
    use std::vector;
    ...
    use pyth_pro_compatible::event::{Self as pyth_event};
    use pyth_pro_compatible::data_source::{Self, DataSource};
    use pyth_pro_compatible::state::{Self as state, State as PythState, LatestOnly};
    use pyth_pro_compatible::price_info::{Self, PriceInfo, PriceInfoObject};
    use pyth_pro_compatible::batch_price_attestation::{Self};
    use pyth_pro_compatible::price_feed::{Self};
    use pyth_pro_compatible::price::{Self, Price};
    use pyth_pro_compatible::price_identifier::{PriceIdentifier};
    use pyth_pro_compatible::setup::{Self, DeployerCap};
    use pyth_pro_compatible::hot_potato_vector::{Self, HotPotatoVector};
    use pyth_pro_compatible::accumulator::{Self};
