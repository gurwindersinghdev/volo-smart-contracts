...
///
/// See `pyth_pro_compatible::state` and `wormhole_simple_majority::package_utils` for more info.
module pyth_pro_compatible::version_control {
    ////////////////////////////////////////////////////////////////////////////
    //
    ...
    ///   `wormhole_simple_majority::package_utils`.
    /// - Add `MigrateComplete` event in `migrate`.
    ///
    /// Also added `migrate__v__0_1_1` in `wormhole_simple_majority::state`, which is
